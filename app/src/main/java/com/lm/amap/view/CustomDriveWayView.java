 ...
 */
public class CustomDriveWayView extends LinearLayout {
    ...
    public CustomDriveWayView(Context context) {
        this(context, null);
    }

    public CustomDriveWayView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomDriveWayView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        lp = new LayoutParams(LayoutParams.WRAP_CONTENT, dp2px(context, IMG_HEIGHT));
        imgLp = new LayoutParams(dp2px(context, IMG_WIDTH), dp2px(context, IMG_HEIGHT));
